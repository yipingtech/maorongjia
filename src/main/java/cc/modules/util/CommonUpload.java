...
public class CommonUpload {
	...
	public String getSavePath() throws Exception {
		String realPath = ServletActionContext.getRequest().getSession().getServletContext().getRealPath(Constants.SPT+savePath);
		return realPath;
	}
	...
	public String getZipSavePath() {
		String realPath = ServletActionContext.getRequest().getSession().getServletContext().getRealPath(Constants.SPT+zipSavePath);
		return realPath;
	}
	...
	public void zipTool(File upload, String uploadFileName, int width, int height) throws IOException {
		...
		try {
			...
			log.info("failure to zip the image.");
			e.printStackTrace();
		} finally {
			if (fosTemp != null)
				fosTemp.close();
