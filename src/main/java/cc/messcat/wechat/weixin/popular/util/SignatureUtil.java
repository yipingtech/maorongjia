...
import cc.messcat.wechat.weixin.popular.bean.pay.PayFeedback;
import cc.messcat.wechat.weixin.popular.bean.pay.PayNativeInput;
import cc.messcat.wechat.weixin.popular.bean.pay.PayNotify;
import cc.messcat.wechat.weixin.popular.bean.pay.PayWarn;
...
public class SignatureUtil {
	...
	public static boolean validateAppSignature(PayNotify payNotify,String paySignKey) {
		...
		log.info("validateAppSignature:"+map);
