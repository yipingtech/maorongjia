...
import cc.messcat.wechat.weixin.popular.bean.paymch.Closeorder;
import cc.messcat.wechat.weixin.popular.bean.paymch.MchBaseResult;
import cc.messcat.wechat.weixin.popular.bean.paymch.MchShorturl;
import cc.messcat.wechat.weixin.popular.bean.paymch.MchShorturlResult;
import cc.messcat.wechat.weixin.popular.bean.paymch.Refundquery;
import cc.messcat.wechat.weixin.popular.bean.paymch.RefundqueryResult;
import cc.messcat.wechat.weixin.popular.bean.paymch.SecapiPayRefund;
import cc.messcat.wechat.weixin.popular.bean.paymch.SecapiPayRefundResult;
...
public class PayMchAPI extends BaseAPI{
	private static Logger log = LoggerFactory.getLogger(PayMchAPI.class); 
