package cc.messcat.wechat.weixin.popular.util;

import java.util.Map;
import java.util.UUID;

import cc.messcat.wechat.weixin.popular.api.JsonUtil;
import cc.messcat.wechat.weixin.popular.bean.pay.PayJsRequest;
import cc.messcat.wechat.weixin.popular.bean.pay.PayNativeReply;
import cc.messcat.wechat.weixin.popular.bean.pay.PayNativeRequest;
import cc.messcat.wechat.weixin.popular.bean.pay.PayPackage;
import cc.messcat.wechat.weixin.popular.bean.paymch.MchPayNativeReply;
...
public class PayUtil {
	...
	public static String generatePayNativeReplyXML(PayPackage payPackage,
		...
		payNativeReply.setNoncestr(UUID.randomUUID().toString().replace("-", ""));
