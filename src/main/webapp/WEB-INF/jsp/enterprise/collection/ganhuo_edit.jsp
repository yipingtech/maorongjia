	...
	<body>
		...
		<%-- 	<tr>
			...
			<tr class="notview"<security:authorize ifAnyGranted="COLLECTION_NEWS_SPECIAL"> style="display:table-row;"</security:authorize>>
				...
				<td>
					<div class="notview" style="display:none;float:left;<security:authorize ifAnyGranted="COLLECTION_NEWS_ISTOP">display:block;</security:authorize>">
						是否为置顶文档:
					...
					<div class="notview" style="display:none;float:left;margin-left:10px;<security:authorize ifAnyGranted="COLLECTION_NEWS_ISCOMMEND">display:block;</security:authorize>">
						是否为推荐文档:
					...
					<div class="notview" style="display:none;float:left;margin-left:10px;<security:authorize ifAnyGranted="COLLECTION_NEWS_ISONLYCONTENT">display:block;</security:authorize>">
						是否为单独内容样式:
			...
			<tr>
				...
				<td><input type="text"  size="10" name="enterpriseNews.clickTimes" value="0" value="${enterpriseNews.clickTimes}"/></td>
			</tr>
