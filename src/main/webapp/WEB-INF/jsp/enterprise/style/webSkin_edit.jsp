...
$(document).ready(function(){
	...
	<body>
		<div class="rhead">
			<div class="rpos">当前位置: 界面风格 - 模板管理 - 编辑模板信息</div>
	...
	<form action="webSkinAction!update.action" method="post" id="columnForm">
		...
		<table class="table table-bordered inner-table">
			...
			<tr>
				<th>模板名称</th>
				<td><input type="text" name="names" value="${webSkin.names}"  size="60" /></td>
			</tr>
			<tr>
				<th>模板文件夹名称</th>
				<td><input type="text" name="filename" value="${webSkin.filename}" size="60" /></td>
			</tr>
			<tr>
				<th>模板描述</th>
				<td>
			...
			<tr>
				...
				<td>
					<select name="webSkin.state">
						...
						<option value="0" <c:if test="${webSkin.state==0}">selected</c:if> >已停用</option>
					</select>
				</td>
			</tr>
			<tr>
