...
// Node object
function Node(id, pid, name, url, title, target, value, checked, icon, iconOpen, open) {
	this.id = id;
	this.pid = pid;
	this.name = name;
	this.url = url;
	this.title = title;
	this.target = target;		this.value = value;				//checkbox的值		this.checked = checked;			//checkbox是否选中
	this.icon = icon;
...
function dTree(objName) {
	...
	this.icon = {
		root				: 'resource/dtree/img/base.gif',
		folder			: 'resource/dtree/img/folder.gif',
		folderOpen	: 'resource/dtree/img/folderopen.gif',
		node				: 'resource/dtree/img/page.gif',
