...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form action="productTypeAction!editProductType.action" method="post" id="productTypeForm" name="productTypeForm" enctype="multipart/form-data">
			<table class="table table-bordered inner-table">
				<input type="hidden" name="id" value="${productType.id}"/>
				<tr>
					<th>类型名称</th>
					<td><input type="text" id="name" name="productType.name" value="${productType.name}" /></td>
				</tr>
