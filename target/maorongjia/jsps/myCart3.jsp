...
<!DOCTYPE HTML>
<html lang="zh-cn" style="height:auto"><!--<![endif]-->
<head>
    <!--meta.jsp-->
    <meta charset="utf-8">
...
<script type="text/javascript">
	...
	<body class='cart' style="height:auto">
	<section class="weui_tab" style="padding-bottom:60px;">
		<section class="account">
					<img  style="margin:0; width:14%;" src="${imagePath}/icon_choose_no.png" id="selectAllImg" alt="" onClick='change_all(this)' style="padding:0">
		...
		<section class="weui_tab_bd body-gary" style="position:relative;" >
			<form style="padding:0" action="epPayAction.htm?pageType=goPay" method="post" class="car-form" id="shopping-cart-list">
								...
								<p class="book_name">${mtag:cutString(cartInfo.product.title,20,'...')}</p>
												<c:choose>
													...
													<c:when test="${empty cartInfo.attributeMap}">
														<section class='car-fome'>
														<img src="${uploadPath}/${cartInfo.product.imgurl}" alt="" class='book_cover'>
														<a style="color: red;font-size: 16px;padding-left:36%;padding-top:5%" href="epProductAction!tampons.action?id=${cartInfo.product.id}">商品已更新，请删除后重新添加购物车</a>
														</section>
												   		<a href="epShoppingCarAction.htm?pageType=deleteFormCart2&cartId=${cartInfo.id}"><img src="${imagePath}/my-car-x.png" alt=""></a>
													</c:when>
													<c:otherwise>
														...
														<input type="hidden" class="totalPrice" value="<fmt:formatNumber value='${cartInfo.productTotal}' maxFractionDigits='2'/>" />
														<span class='book_price clearfix'>
														<span class="one_price">￥<fmt:formatNumber value="${cartInfo.productPrice}" pattern="0.00"  maxFractionDigits="2"/></span>
					...
					$.ajax({ 
					   url:'${ctx}/ajaxepShoppingCarAction!updateCart.htm', 
							...
							success: function(json) {
					      		...
					      		$(obj).siblings('.one_price').val(json.price.toFixed(2));
		  ...
		  <!-- scroll end -->	
			 ...
			 <%@ include file="/jsps/modules/footer3.jsp"%>
	</section>  
	</body>
